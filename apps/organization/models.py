...
class CourseOrg(models.Model):
    ...
    catgory = models.CharField(max_length=20, verbose_name=u'机构类别', default='pxjg', choices=(("pxjg", "培训机构"),('gr', '个人'),('gx', '高校')))
    click_nums = models.IntegerField(default=0, verbose_name=u'点击数')
    fav_nums = models.IntegerField(default=0, verbose_name=u'收藏数')
    image = models.ImageField(upload_to="org/%Y/%m", verbose_name=u'log', max_length=100)
